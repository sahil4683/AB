...
export class App implements OnInit {
  ...
  //     category: { id: 1, name: 'Industrial Chemicals', slug: 'industrial-chemicals', url: '/industrial-chemicals' },
  //     slug: 'r-2-amino-2-cyclohexa-1-4-dien-1-yl-acetic-acid',
  //     anchor: 'r-2-amino-2-cyclohexa-1-4-dien-1-yl-acetic-acid',
  //   },
  //   {
  //     id: 2,
  //     title:
  ...
  //     category: { id: 2, name: 'Laboratory Chemical', slug: 'laboratory-chemical', url: '/laboratory-chemical' },
  //     slug: '2-acetamido-2-deoxy-alpha-d-glucopyranosylchloride-3-4-6-triacetate',
  //     anchor: '2-acetamido-2-deoxy-alpha-d-glucopyranosylchloride-3-4-6-triacetate',
  //   },
  //   {
  //     id: 3,
  //     title:
  ...
  //     category: { id: 3, name: 'Pharmaceutical Ingredients', slug: 'pharmaceutical-ingredients', url: '/pharmaceutical-ingredients' },
  //     slug: '4s-4-aminomethyl-1-3-oxazolidin-2-one-1hydrochloride-salt',
  //     anchor: '4s-4-aminomethyl-1-3-oxazolidin-2-one-1hydrochloride-salt',
  //   },
  //   {
  //     id: 4,
  ...
  //     category: { id: 4, name: 'Speciality Chemicals', slug: 'speciality-chemicals', url: '/speciality-chemicals' },
  //     slug: 'anti-human-igg-gama-chain-specific-fitc',
  //     anchor: 'anti-human-igg-gama-chain-specific-fitc',
  //   },
  //   {
  //     id: 5,
  ...
  //     category: { id: 1, name: 'Industrial Chemicals', slug: 'industrial-chemicals', url: '/industrial-chemicals' },
  //     slug: 'dehydroisoandrosterone-3-sulfate-sodium-salt-dihydrate',
  //     anchor: 'dehydroisoandrosterone-3-sulfate-sodium-salt-dihydrate',
  //   },
  //   {
  //     id: 6,
  ...
  //     category: { id: 1, name: 'Industrial Chemicals', slug: 'industrial-chemicals', url: '/industrial-chemicals' },
  //     slug: 'n-2-acetamido-phenethyl-1-hydroxy-2-naphthamide',
  //     anchor: 'n-2-acetamido-phenethyl-1-hydroxy-2-naphthamide',
  //   },
  //   {
  //     id: 7,
  ...
  //     category: { id: 1, name: 'Industrial Chemicals', slug: 'industrial-chemicals', url: '/industrial-chemicals' },
  //     slug: '3-acetamido-5-boronic-benzoic-acid',
  //     anchor: '3-acetamido-5-boronic-benzoic-acid',
  //   },
  //   {
  //     id: 8,
  ...
  //     category: { id: 1, name: 'Industrial Chemicals', slug: 'industrial-chemicals', url: '/industrial-chemicals' },
  //     slug: '2-acetamido-5-fluorobenzoic-acid',
  //     anchor: '2-acetamido-5-fluorobenzoic-acid',
  //   },
  // ];
